		...
		},
		{
			...
			children: [{
				...
				},
				{
					...
					children: [{
							path: '/all_task',
							component: resolve => require(['../components/all_task.vue'], resolve),
							meta: {
								title: '全部任务'
							}
						},
						{
							path: '/finished',
							component: resolve => require(['../components/finished.vue'], resolve),
							meta: {
								title: '已完成的任务',
							}
						},
						{
							path: '/not_finished',
							component: resolve => require(['../components/not_finished.vue'], resolve),
							meta: {
								title: '未完成的任务'
							}
						},
						{
							path: '/outtime',
							component: resolve => require(['../components/outtime.vue'], resolve),
							meta: {
								title: '超时任务'
							}
						}
